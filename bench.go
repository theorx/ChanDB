...
func main() {
	...
	writeStatsMixed("5M w50-r50 50M seed", benchMixed(SEED_5_MIL, 50, 50, SEED_50_MIL))
	writeStats("20M writes", benchWrite20MIL(), SEED_20_MIL)
	writeStats("20M reads", benchRead20MIL(), SEED_20_MIL)
	writeStats("20M writes 100M seed", benchWrite20MIL100MSeed(), SEED_20_MIL)
	writeStats("20M reads 100M seed", benchRead20MIL100MSeed(), SEED_20_MIL)
	writeStatsMixed("20M w50-r50 50M seed", benchMixed(SEED_20_MIL, 50, 50, SEED_50_MIL))
	writeStatsMixed("20M w25-r75 50M seed", benchMixed(SEED_20_MIL, 25, 75, SEED_50_MIL))
	writeStatsMixed("20M w75-r25 50M seed", benchMixed(SEED_20_MIL, 75, 25, SEED_50_MIL))
	writeStatsMixed("20M w90-r10 50M seed", benchMixed(SEED_20_MIL, 90, 10, SEED_50_MIL))
	writeStatsMixed("20M w10-r90 50M seed", benchMixed(SEED_20_MIL, 10, 90, SEED_50_MIL))
	writeStatsMixed("20M w50-r50 no seed", benchMixed(SEED_20_MIL, 50, 50, 0))
	writeStatsMixed("20M w75-r25 no seed", benchMixed(SEED_20_MIL, 75, 25, 0))
	writeStatsMixed("20M w90-r10 no seed", benchMixed(SEED_20_MIL, 90, 10, 0))
